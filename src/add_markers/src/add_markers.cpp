...
uint8_t arrival_data_previous=0;
bool finish = false;
...
int main( int argc, char** argv )
{
  ...
  while (ros::ok())
  {
  ros::spinOnce(); //To ensure the node receive the subscriber messages

  if (arrival_data!=arrival_data_previous) {
    	print_info=true;
  } 
  ...
  if (arrival_data==2) {
    ...
    arrival_data_previous=arrival_data;
